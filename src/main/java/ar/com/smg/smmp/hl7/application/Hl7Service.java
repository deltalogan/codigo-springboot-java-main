...
/**
 * Servicio de aplicación para operaciones HL7 del SMMP.
 * Reemplaza al antiguo Hl7ServiceBean (EJB).
 */
@Service
public class Hl7Service {
    ...
    public HL7AnulaDiagnosticoResp anulaDiagnostico(HL7AnulaDiagnostico hl7AnulaDiagnostico) {
    ...
    public HL7InfoDiagnosticoResp informaDiagnostico(HL7InfoDiagnostico hl7InfoDiagnostico) {
        ...
        if (!resultMaps.isEmpty()) {
            resp.setCabecera((HL7InfoDiagnosticoCab) findMultipleResultMapHeader(resultMaps));
    ...
    public HL7ConsultaAutoResp consultaAuto(HL7ConsultaAuto hl7ConsultaAuto) {
        ...
        if (!resultMaps.isEmpty()) {
            resp.setCabecera((HL7ConsultaAutoCab) findMultipleResultMapHeader(resultMaps));
            if (resultMaps.size() > 1) {
    ...
    @SuppressWarnings("unchecked")
    public HL7ConsultaTotalesResp consultaTotales(HL7ConsultaTotales hl7ConsultaTotales) {
        ...
        if (!resultMaps.isEmpty()) {
            resp.setCabecera((HL7ConsultaTotalesCab) findMultipleResultMapHeader(resultMaps));
            if (resultMaps.size() > 1) {
    ...
    @SuppressWarnings("unchecked")
    public HL7CancelPrestacResp cancelacionPrestaciones(HL7CancelPrestac hl7CancelPrestac) {
        ...
        if (!resultMaps.isEmpty()) {
            resp.setCabecera((HL7CancelPrestacCab) findMultipleResultMapHeader(resultMaps));
            if (resultMaps.size() > 1) {
    ...
    // ====================== MÉTODOS DE GEOPOSICIÓN ======================

    @Transactional(readOnly = true)
    public HL7Geoposicion consultaGeoposicion(Integer codigoTx) {
        if (codigoTx == null) {
            throw new SMMPRuntimeException("hl7ConsultaGeoposicion no puede ser nulo");
        }
    ...
    public HL7Geoposicion informaGeoposicion(HL7Geoposicion hl7Geoposicion) {
        ...
        if (mapper.consultaGeoposicion(trx) != null) {
            throw new HL7DuplicateException("La transacción ya tiene una geoposición asociada.");
        }
    ...
    public List<HL7ConsultaPrestacionExceptuada> consultaPrestacionExceptuada(HL7ConsultaPrestacionExceptuada param) {
        if (param == null) {
            throw new SMMPRuntimeException("HL7ConsultaPrestacionExceptuada no puede ser nulo");
        }

        List<HL7ConsultaPrestacionExceptuada> list = mapper.consultaPrestacionesExceptuadas(param);
        if (list == null) {
            throw new Hl7InexistenteException();
        }
        return list;
    ...
    @SuppressWarnings("unchecked")
    private ArrayList<Object> wrapperComprobante(List<Object> reimprimirComprobante) {
        ...
        List<Object> cabComprobanteList = (List<Object>) reimprimirComprobante.get(0);
        ...
        for (Object o : cabComprobanteList) {
            ...
            comprobante.put("codigos", regProdDetalle);   // se repite el detalle para cada cabecera
    ...
    private Object findMultipleResultMapHeader(List<Object> resultMaps) {
        ...
        // Caso de múltiples resultados (cabecera + detalle)
