...
public interface Hl7Mapper {
    ...
    HL7AnulaDiagnosticoResp anulaDiagnostico(
    ...
    List<HL7ConsultaPrestacionExceptuada> consultaPrestacionesExceptuadas(
            HL7ConsultaPrestacionExceptuada consultaPrestacionExceptuada);
}