...
@Setter
@Getter
@Schema(name = "HL7ElegibilidadResp",
		description = "DTO de respuesta HL7 para consulta de elegibilidad.")
public class HL7ElegibilidadResp implements Serializable {
	@Serial private static final long serialVersionUID = -6500989855869348394L;
	...
	@Schema(description = "Descripción del rechazo de cabecera.",
