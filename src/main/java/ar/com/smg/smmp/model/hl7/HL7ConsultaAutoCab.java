...
@Setter
@Getter
@Schema(name = "HL7ConsultaAutoCab",
		description = "Cabecera de respuesta HL7 para consulta de autorizaciones "
				+ "automáticas.")
public class HL7ConsultaAutoCab implements Serializable {
	@Serial private static final long serialVersionUID = -2039849269234172675L;
