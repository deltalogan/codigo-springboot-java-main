...
@Setter
@Getter
@Schema(name = "HL7InfoDiagnostico",
		description = "DTO de solicitud HL7 para consulta o registro de "
				+ "información de diagnóstico.")
public class HL7InfoDiagnostico implements Serializable {
	@Serial private static final long serialVersionUID = -576280222852124841L;
	...
	@Schema(description = "Número de ticket asociado a la operación.",
			example = "456789")
	...
	private String cuit;
	@Schema(description =
			"Código o descripción de diagnóstico informada en la solicitud.",
			example = "J189")
	private String diag;
