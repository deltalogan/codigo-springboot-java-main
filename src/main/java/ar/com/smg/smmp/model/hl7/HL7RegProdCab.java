...
@Setter
@Getter
@Schema(name = "HL7RegProdCab",
		description =
				"Cabecera de respuesta HL7 para registro de producto o prestación.")
public class HL7RegProdCab implements Serializable {
	@Serial private static final long serialVersionUID = 630526773617124844L;
	...
	private String sexo;
	@Schema(description = "Sexo utilizado para autorización automática.",
			example = "M")
	private String sexoAuto;
	@Schema(description = "Género utilizado para autorización automática.",
			example = "M")
	...
	@Schema(description = "Descripción asociada al código ICD.",
			example = "DIAGNOSTICO INFORMADO")
	private String icdDeno;
	@Schema(description = "Nombre del prestador informado en la respuesta.",
			example = "SANATORIO CENTRAL")
	private String nomPrestad;
	@Schema(description = "Número o código de sucursal asociado a la operación.",
			example = "10")
