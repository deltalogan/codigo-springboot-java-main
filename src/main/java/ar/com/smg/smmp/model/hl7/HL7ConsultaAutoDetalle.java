...
@Setter
@Getter
@Schema(name = "HL7ConsultaAutoDetalle",
		description =
				"Detalle de respuesta HL7 para consulta de autorizaciones automáticas.")
public class HL7ConsultaAutoDetalle implements Serializable {
	@Serial private static final long serialVersionUID = -8897985909658520002L;
	@Schema(
