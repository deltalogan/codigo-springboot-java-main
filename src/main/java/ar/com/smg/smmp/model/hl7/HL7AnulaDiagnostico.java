...
@Setter
@Getter
@Schema(name = "HL7AnulaDiagnostico",
		description = "DTO de solicitud HL7 para anulación de diagnóstico.")
public class HL7AnulaDiagnostico implements Serializable {
	@Serial private static final long serialVersionUID = 5830944862603589202L;
