...
@Setter
@Getter
@Schema(name = "HL7RegProdDetalle",
		description =
				"Detalle de respuesta HL7 para registro de producto o prestación.")
public class HL7RegProdDetalle implements Serializable {
	@Serial private static final long serialVersionUID = -1104539175534306442L;
	@Schema(
