...
@Schema(name = "HL7RegProd",
		description =
				"DTO de solicitud HL7 para registro de producto o prestación.")
public class HL7RegProd implements Serializable {
	@Serial private static final long serialVersionUID = 4991377569526175748L;
	@Setter
	@Getter
	...
	@Getter
	@Schema(
			description = "Código ICD informado en la solicitud.", example = "J189")
	private String icd;
	@Setter
	@Getter
	@Schema(description =
	...
	@Setter
	@Getter
	@Schema(description = "Parámetro adicional 3 utilizado por la integración.",
			example = "VALOR3")
	private String param3;
	@Setter
	@Getter
	@Schema(description = "Tipo de efector informado en la solicitud.",
			example = "PRESTADOR")
	...
	@Setter
	@Getter
	@Schema(description = "Tipo de prescriptor informado en la solicitud.",
			example = "MEDICO")
	...
	@Setter
	@Getter
	@Schema(description = "Identificador único de mensaje.",
			example = "MSG-20260430-0001")
	...
	@Setter
	@Getter
	@Schema(description = "Código de rechazo agregado a nivel cabecera.",
			example = "0")
	...
	@Getter
	@Schema(
			description = "Indicador de origen o compatibilidad con PowerBuilder.",
			example = "false")
